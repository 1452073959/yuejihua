...
//        dump($arr);
  ...
  "HBRCU": "河北省农村信用社"
        ...
        $a = json_decode($a, true);
        $req = request()->param();
        $bank = httpget('https://ccdcapi.alipay.com/validateAndCacheCardInfo.json?_input_charset=utf-8&cardNo=' . $req['bank'] . '&cardBinCheck=true');
        $bankname = json_decode($bank, true);
